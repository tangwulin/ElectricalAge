...
//			transparentNodeItem.addDescriptor(subId + (id << 6), descriptor);
    ...
    private void registerElectricalCable(int id) {
        ...
        /*{
            ...
            desc.setPhysicalConstantLikeNormalCable(LVU, LVP, 0.2 / 20,LVU * 1.3, LVP * 1.2,20,cableWarmLimit,-100,cableHeatingTime, cableThermalConductionTao);
            sixNodeItem.addDescriptor(subId + (id << 6), desc);
			//then describe battery cable
            desc = new ElectricalCableDescriptor(name, stdCableRender50V,"Battery Cable.", false);
            desc.setPhysicalConstantLikeNormalCable(LVU, LVP / 4, 0.2 / 20,LVU * 1.3, LVP * 1.2,20,cableWarmLimit,-100,cableHeatingTime, cableThermalConductionTao);
